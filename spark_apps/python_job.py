...
book = spark.read.text("/opt/bitnami/spark/data/pride-and-prejudice.txt")
...
results.coalesce(1).write.csv("/opt/bitnami/spark/data/results/chapter03/simple_count.csv")